...
const Header = ({ isDarkMode, toggleTheme, pathname }: { isDarkMode: boolean; toggleTheme: () => void; pathname: string }) => (
...
function LayoutContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className={`min-h-screen flex flex-col ${isDarkMode ? 'dark bg-background text-foreground' : 'bg-background text-foreground'}`}>
            <Header isDarkMode={isDarkMode} toggleTheme={toggleTheme} pathname={pathname} />
